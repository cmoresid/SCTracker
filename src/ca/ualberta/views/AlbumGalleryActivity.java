...
public class AlbumGalleryActivity extends Activity implements Handler.Callback {
	 ...
	 * objects.
	 */
	private AlbumGalleryListAdapter mListAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View v,
				...
				// *
				Intent i = new Intent(AlbumGalleryActivity.this,
		...
		mController = new AlbumGalleryController(mTags);
		...
		mListAdapter = new AlbumGalleryListAdapter(mTags);
	...
	private void retrieveData() {
		...
		mController.handleMessage(AlbumGalleryController.GET_TAGS, null);
	}
	...
	protected void onResume() {
		...
		super.onResume();
		mController.handleMessage(AlbumGalleryController.GET_PHOTOS_COUNT, null);
		mController.handleMessage(AlbumGalleryController.GET_TAGS, null);
	}
	...
	public boolean onContextItemSelected(MenuItem item) {
		...
		case MENU_DELETE_TAG_AND_PHOTOS:
			return mController.handleMessage(
					AlbumGalleryController.DELETE_TAG_AND_PHOTOS,
	...
	public boolean handleMessage(Message msg) {
		switch (msg.what) {
		case AlbumGalleryController.UPDATED_ENTRIES:
			...
			return true;
		case AlbumGalleryController.GET_PHOTOS_COUNT:
